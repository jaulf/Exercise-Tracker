            ...
            <nav className='whitespace-nowrap lg:px-20 lg:py-8 pr-2 pl-4 py-4 font-nuni lg:flex items-center lg:justify-between text-gray-800 '>
                ...
                <ul id='menu' className='lg:uppercase lg:font-light lg:text-sm normal-case hidden lg:items-center lg:flex lg:flex-row text-base tracking-wider pt-4 px-8 lg:px-0'>
                    <li class='lg:px-11 lg:py-0  py-4 '>
                        <Link onClick={displayNav} to='/' >Home</Link>
                    </li>
                    <li class='lg:px-11 lg:py-0  py-4 '>
                        <Link onClick={displayNav} to='/create-exercise' >Create Exercise</Link>
                    </li>
                    <li class='lg:px-11 lg:py-0 py-4'>
                        <Link onClick={displayNav} to='/' >Exercises</Link>
                    </li>
                </ul>
                            ...
                            return (
                                <ul className=' px-8 lg:flex items-center'>
                                    <li className=' font-semibold py-4 flex items-center lg:mx-3'>
                                        ...
                                        <Link onClick={displayNav} className='' to='/signin'>Log In</Link>
                                    </li>
                                    <li className=' font-semibold py-4 '> 
                                        <Link onClick={displayNav} className='' to='/signup'>Sign up</Link>
                                    </li>
                                </ul>
                            )
                        } else {
