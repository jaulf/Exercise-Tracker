                 ...
                 <form className=' w-full'>
                    ...
                    <div className='lg:py-24 py-16'>
                        ...
                        <div class=' shadow-lg rounded-md w-full max-w-5xl'>
                            ...
                            <div class='border-gray-100 border-t p-6 flex items-center justify-between'>
                                <div class=''>
                                    <p className='flex justify-center items-center bg-purple-600 text-white h-10 w-10 rounded-full'>1</p>
                                </div>
                                <div class=''>
                                    <p className='py-2 font-semibold'>Push Ups</p>
                                    <div className='py-2 tracking-wider text-purple-600 flex flex-0'>
                                        <p className='pr-6'>45secs exercise duration</p>
                                        <p className='px-6'>15secs rest duration</p>
                                    </div>
                                </div>
                                <div class=''>
                                    <p className='block bg-red-600 text-white rounded-full px-6 py-3'>Cancel</p>
                                </div>
                            </div>

                            <div class='border-gray-100 border-t p-6 flex items-center justify-between'>
                                <div class=''>
                                    <p className='flex justify-center items-center bg-purple-600 text-white h-10 w-10 rounded-full'>2</p>
                                </div>
                                <div class=''>
                                    <p className='py-2 font-semibold'>Sit Ups</p>
                                    <div className='py-2 tracking-wider text-purple-600 flex flex-0'>
                                        <p className='pr-6'>45secs exercise duration</p>
                                        <p className='px-6'>15secs rest duration</p>
                                    </div>
                            ...
                            <div class='border-gray-100 border-t p-6 flex items-center justify-between'>
                                <div class=''>
                                    <p className='flex justify-center items-center bg-purple-600 text-white h-10 w-10 rounded-full'>3</p>
                                </div>
                                <div class=''>
                                    <p className='py-2 font-semibold'>Mountain Climbers</p>
                                    <div className='py-2 tracking-wider text-purple-600 flex flex-0'>
                                        <p className='pr-6'>45secs exercise duration</p>
                                        <p className='px-6'>15secs rest duration</p>
                                    </div>
